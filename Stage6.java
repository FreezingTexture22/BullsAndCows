...
public class Stage6 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			NumberOfPossibleSymbols = in.nextInt();

			if (NumberOfPossibleSymbols > 0 && NumberOfPossibleSymbols < 37) {
				lengthIsOk = true;
			} else {
				System.out.println(
						"Wrong number of possible symbols in the code. Must be in range from 1 to 36 inclusive!");
			}
		...
		if (NumberOfPossibleSymbols <= 10) {
			...
			System.out.println(" (0-" + (NumberOfPossibleSymbols) + ").");
